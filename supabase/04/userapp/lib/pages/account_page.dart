...
import 'package:userapp/components/avatar.dart';
...
class _AccountPageState extends State<AccountPage> {
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      if (mounted) {
        context.showErrorSnackBar(message: 'Successfully updated profile!');
      }
    } on PostgrestException catch (error) {
      context.showErrorSnackBar(message: error.message);
    } catch (error) {
  ...
  ///Called when image has been uploaded to Supabase storage
